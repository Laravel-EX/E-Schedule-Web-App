                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <a href="?page=lokasi/edit.php&p=<?php echo $id_lokasi; ?>" class="btn btn-primary">Edit</a>
                                        <a href="?page=lokasi/proses.php&p=<?php echo $id_lokasi; ?>&hapus=hapus" class="btn btn-danger">Delete</a>
                                      </td>
                                    </tr>
                                    <?php } ?>
                                  </tbody>
